...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.ilike'
        db.add_column(u'groups_topic', 'ilike',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Topic.dislike'
        db.add_column(u'groups_topic', 'dislike',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.ilike'
        db.delete_column(u'groups_topic', 'ilike')

        # Deleting field 'Topic.dislike'
        db.delete_column(u'groups_topic', 'dislike')
    ...
    models = {
        u'User.myuser': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
        ...
        u'groups.group': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            ...
            'last_topic_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            ...
            'modify_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
        ...
        u'groups.topic': {
            ...
            'last_reply_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            'modify_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
