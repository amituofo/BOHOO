...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Catelog', fields ['cate_name']
        db.create_index(u'groups_catelog', ['cate_name'])

        # Adding unique constraint on 'Catelog', fields ['cate_name']
        db.create_unique(u'groups_catelog', ['cate_name'])


        # Changing field 'Topic.create_time'
        db.alter_column(u'groups_topic', 'create_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Topic.modify_time'
        db.alter_column(u'groups_topic', 'modify_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Removing unique constraint on 'Catelog', fields ['cate_name']
        db.delete_unique(u'groups_catelog', ['cate_name'])

        # Removing index on 'Catelog', fields ['cate_name']
        db.delete_index(u'groups_catelog', ['cate_name'])


        # Changing field 'Topic.create_time'
        db.alter_column(u'groups_topic', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Topic.modify_time'
        db.alter_column(u'groups_topic', 'modify_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    models = {
        u'User.myuser': {
            'Meta': {'object_name': 'MyUser'},
            'activation_key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
        ...
        u'groups.group': {
            ...
            'last_topic_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
        ...
        u'groups.topic': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_reply_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
            'modify_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
