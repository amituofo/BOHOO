...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.member_nick'
        db.add_column(u'groups_group', 'member_nick',
                      self.gf('django.db.models.fields.CharField')(default='\xe6\x88\x90\xe5\x91\x98', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.member_nick'
        db.delete_column(u'groups_group', 'member_nick')
