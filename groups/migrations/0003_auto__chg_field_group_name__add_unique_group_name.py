...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'groups_group', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Adding index on 'Group', fields ['name']
        db.create_index(u'groups_group', ['name'])

        # Adding unique constraint on 'Group', fields ['name']
        db.create_unique(u'groups_group', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Group', fields ['name']
        db.delete_unique(u'groups_group', ['name'])

        # Removing index on 'Group', fields ['name']
        db.delete_index(u'groups_group', ['name'])


        # Changing field 'Group.name'
        db.alter_column(u'groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))
