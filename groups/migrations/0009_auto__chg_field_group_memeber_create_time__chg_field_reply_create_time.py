...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group_memeber.create_time'
        db.alter_column(u'groups_group_memeber', 'create_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Reply.create_time'
        db.alter_column(u'groups_reply', 'create_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Group_memeber.create_time'
        db.alter_column(u'groups_group_memeber', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Reply.create_time'
        db.alter_column(u'groups_reply', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    models = {
        u'User.myuser': {
            'Meta': {'object_name': 'MyUser'},
            'activation_key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
        ...
        u'groups.group': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            ...
            'last_topic_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            ...
            'modify_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
        ...
        u'groups.topic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_reply_add': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
            'modify_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 28, 0, 0)'}),
